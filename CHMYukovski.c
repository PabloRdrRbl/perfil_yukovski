...
int main(int argc, char const *argv[])
{
	...
	fprintf(readme, "Este programa esta diseñado para realizar la transformación de Yukovski sobre una circunferencia y conseguir un perfil alar (obteniendo puntos e imágenes).\n");
	fprintf(readme, "Después aplicamos el teorema de Kutta-Yukovski para analizar el flujo de aire sobre un cilindro.\n");
	fprintf(readme, "Por último, se analiza el flujo sobre el perfil alar (SIN tener en cuenta las turbulencias).\n");
