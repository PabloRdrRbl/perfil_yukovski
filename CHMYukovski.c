...
int main(int argc, char const *argv[])
{
	...
	if (popen ("gnuplot","w"))
	{
		...
		opc[0] = 7;  // 1: (p)oint(t)ype   2: (p)oint(s)ize   3: (l)ine(t)ype    4:(pattern) malla     5:(l)ine(c)olor malla       6:numero plot
		opc[1] = 0.75;
		opc[2] = 1;
		opc[3] = 2;
		opc[4] = 7;		
		...
		opp[0] = 7;  // 1: (p)oint(t)ype   2: (p)oint(s)ize   3: (l)ine(t)ype    4:(pattern) malla     5:(l)ine(c)olor malla       6:numero plot
		opp[1] = 0.5;	
		opp[2] = 1;	
		opp[3] = 2;
		opp[4] = 9;
